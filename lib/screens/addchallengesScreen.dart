...
class AddChallengesScreen extends StatefulWidget {

  var AdminName;

  AddChallengesScreen({this.AdminName});
...
class _AddChallengesScreenState extends State<AddChallengesScreen> {
  ...
  TextEditingController editchallengesNameTextEditingController = TextEditingController();
  TextEditingController editchallengesDescTextEditingController = TextEditingController();
  TextEditingController challengesDescTextEditingController = TextEditingController();
  ...
  var newselectedValue, _openAI, openAiApiKeyFromFirebase;
  List<dynamic> editKeywordssss = [];
  List<dynamic> edittags = [];


  var editstatusvalue,editsourceValue;
  ...
  //
  //     docssssss.map((e) => print("errrrroooorrr$e"));
  //     final dc =  docssssss.where((element) {
  //       // print("inside docssssss ${element.data()}");
  //
  //       print("inside docssssss get ${element.get("Label").toLowerCase()}");
  //
  //       var name  = element.get("Label").toLowerCase();
  //       // var description = element.get('Description').toString().toLowerCase();
  //       var category = element.get('tags').toString().toLowerCase();
  //       // var keywords = element.get('Keywords').toString().toLowerCase();
  //
  ...
  //       }
  //
  //      else if(category.contains(search.toLowerCase())){
  //         print("inisde element name $category and element is $element");
  //         return true;
  //       }
  //
  //       return false;
  ...
  //     documents.clear();
  //     documents.addAll(dc);
  //     // List<DocumentSnapshot> products = await searchProductsByDescription(search);
  //
  ...
  //     //     .then((QuerySnapshot querySnapshot) {
  //     //
  //     //       querySnapshot.docs.where((element) =>element.name )
  //     //   // print("querySnapshot.docs name ${querySnapshot.docs}");
  //     //   // documents.addAll(querySnapshot.docs);
  //     //   // print("inside Name");
  //     //
  ...
  void initState() {
    ...
    _challengeProvider = Provider.of<ChallengesProvider>(context, listen: false);
    getQuestions();
    Selectcategories();
                                ...
                                return Padding(
                                  ...
                                  child: TypeAheadField(
                                    ...
                                    onSuggestionSelected: (String suggestion) async {
                                      print('onSuggestionSelected suggestion $suggestion before  ${challengesProvider.searchbycategory}');
                                      // addKeywordProvider.addkeywordschip(suggestion,editKeywordssss);

                                      challengesProvider.addkeywordschip(suggestion,challengesProvider.searchbycategory);
                                      // setState(() { });
                                      ...
                                      print('onSuggestionSelected after  ${_challengeProvider.searchbycategory}');
                                    },
                        ...
                        Container(
                          ...
                          child: Consumer<ChallengesProvider>(
                              builder: (c,challengesProvider, _){
                                ...
                                return (challengesProvider.searchbycategory.isNotEmpty) ? Padding(
                                  ...
                                  child: Align(
                                    ...
                                    child: SingleChildScrollView(
                                      ...
                                      child: Wrap(
                                        ...
                                        children: challengesProvider.searchbycategory.map((item){
                                          print("item: $item");
                                          print("searchbycat_challengeProvider: ${_challengeProvider.searchbycategory}");
                                          return Container(
                                            height: 40,
                                            // width: 200,
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                IconButton(
                                                    onPressed: ()async{
                                                      setState(() {
                                                        challengesProvider.removesearchcat(item);
                                                        _challengeProvider.loadDataForPageFilter(1,'Keywords',_challengeProvider.searchbycategory);
                                                        _challengeProvider.setFirstpageNo();
                                                        _challengeProvider.lengthOfdocument = null;
                                                      });
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Consumer<ChallengesProvider>(
                              builder: (c,challengesProvider, _){
                                return (challengesProvider.searchbytag.isNotEmpty) ? Padding(
                                  ...
                                  child: Align(
                                    ...
                                    child: SingleChildScrollView(
                                      ...
                                      child: Wrap(
                                        ...
                                        alignment: WrapAlignment.start,
                                        runAlignment: WrapAlignment.start,
                                        children: challengesProvider.searchbytag.map((item){
                                          return Container(
                                            height: 40,
                                            // margin: EdgeInsets.only(bottom: 10),
                                            padding: EdgeInsets.all(5),
                                              ...
                                              children: [
                                                ...
                                                IconButton(
                                                    onPressed: (){
                                                      // setState(() {
                                                      setState(() {
                                                        challengesProvider.removesearchtags(item);
                                                        _challengeProvider.loadDataForPageFilter(1,'tags',_challengeProvider.searchbytag);
                                                        _challengeProvider.setFirstpageNo();
                                                        _challengeProvider.lengthOfdocument = null;
                                                      });
                                                      // _challengeProvider.searchbytag.remove(item);
                                                      // });
                                                    },
                                                    icon: Icon(Icons.dangerous_sharp,size: 15, color: Colors.black38,)
                                                ),
                                    ...
                                    Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: DropdownButtonFormField<String>(
                                          value: challengesProvider.selectAllAny,
                                          // value: 'Thrivers Category',
                                          // value: ,
                                          onChanged: (value) async {
                                            challengesProvider.updateselectAllAny(value!,searchTextbyCKEditingController.text );
                                          },
                                          // onChanged: null,
                                          items: challengesProvider.searchAllAny.map((item) {
...
//                   )
  ...
  Widget ChallengesListTile(DocumentSnapshot<Object?> challengesDetails, i, documents) {
    ...
    var keys = challengesDetails["Keywords"].join(",");

    var tags = challengesDetails["tags"].join(",");

    List<TextSpan> getClickableKeywords(keywordsString) {
      var keywords = challengesDetails["Keywords"];
            ...
            recognizer: TapGestureRecognizer()
              ..onTap = () {
                setState(() {
                  ...
                  _challengeProvider.addkeywordschip(keyword,_challengeProvider.searchbycategory);
                  _challengeProvider.loadDataForPageFilter(1,'Keywords',_challengeProvider.searchbycategory);
                  _challengeProvider.setFirstpageNo();
    ...
    List<TextSpan> getClickableTags(keywordsString) {
      var Tags = challengesDetails["tags"];
            ...
            recognizer: TapGestureRecognizer()
              ..onTap = () {
                ...
                setState(() {
                  ...
                  // search(keyword);
                  _challengeProvider.addtags(tag,_challengeProvider.searchbytag);
                  _challengeProvider.loadDataForPageFilter(1,'tags',_challengeProvider.searchbytag);
                  _challengeProvider.setFirstpageNo();
    ...
    return Row(
      ...
      children: [
              ...
              Expanded(
                child: InkWell(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      !selectedFieldNames.contains("Label")?Text(challengesDetails['Label'],style: Theme.of(context).textTheme.titleMedium,overflow: TextOverflow.ellipsis):Container(),
                      !selectedFieldNames.contains("Description")?Text(challengesDetails['Description'],style: Theme.of(context).textTheme.subtitle1?.copyWith(color: Colors.grey,overflow: TextOverflow.ellipsis),maxLines: 2,):Container(),
                      SizedBox(height: 10),
        ...
        Container(
          ...
          child: Column(
            children: [
              Text("${challengesDetails['Original Description']}",),
            ],
          ),
        ),
        SizedBox(width: 30,),
          ...
          child: Row(
            ...
            children: [
              IconButton(
                  ...
                  color: primaryColorOfApp,
                  onPressed: () async {
                    // print("object: ${challengesDetails.id} , ${challengesDetails['Name']}, ${challengesDetails['Description']}, ${challengesDetails['Category']}, ${challengesDetails['Keywords']} ,${challengesDetails['Created Date']},${challengesDetails['Created By']},${challengesDetails['Modified By']},${challengesDetails['Modified Date']}}");
                          ...
                          InkWell(
                            onTap: () async {
                              ...
                              await ApiRepository().createchallenges({
                                'id': ids,
                                "Source" : challengeProvider.selectsourceItems,
                                "Challenge Status" : challengeProvider.selectThriversStatusItems,
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                            ...
                            children: <Widget>[
                                  ...
                                  Flexible(
                                    child: Padding(
                                      ...
                                      child: DropdownButtonFormField<String>(
                                        ...
                                        // value: ,
                                        onChanged: (value) async {
                                          challengeProvider.selectsourceItems = value;
                                        },
                                        // onChanged: null,
                                        items: challengeProvider.ChallengesSourceItems.map((item) {
                                          return DropdownMenuItem<String>(
                                            value: item,
                                            child: Text(item),
                                          );
                                  ...
                                  Flexible(
                                    child: Padding(
                                      ...
                                      child: DropdownButtonFormField<String>(
                                        ...
                                        // value: ,
                                        onChanged: (value) async {
                                          challengeProvider.selectThriversStatusItems = value;
                                        },
                                        // onChanged: null,
                                        items: challengeProvider.ChallengesStatusItems.map((item) {
                                          return DropdownMenuItem<String>(
                                            value: item,
                                            child: Text(item),
                                          );
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          contentPadding: EdgeInsets.only(
                                              top: 25, bottom: 25, left: 32, right: 22),
                                          labelText: 'Challenges Status',
                                          hintText: 'Challenges Status',
                                          labelStyle: TextStyle(color: Colors.black),
                                          border: OutlineInputBorder(
                                              borderSide: BorderSide(color: Colors.black),
                                              borderRadius: BorderRadius.circular(15)
                              ...
                              //   child: TextField(
                              //     maxLines: null,
                              //     controller: challengesDescTextEditingController,
                              //     //cursorColor: primaryColorOfApp,
                              //     onChanged: (value) {
                              //
                              //     },
                                                ...
                                                children: [
                                                  ...
                                                  IconButton(
                                                      onPressed: ()async{
                                                        ...
                                                        _challengeProvider.keywordsssss.remove(item);
                                                      },
                              ...
                              Padding(
                                ...
                                child: TypeAheadField(
                                  ...
                                  onSuggestionSelected: (String suggestion) {
                                    ...
                                    _challengeProvider.addtags(suggestion,_challengeProvider.ProviderTags);
                                  ...
                                  textFieldConfiguration: TextFieldConfiguration(
                                    ...
                                    onSubmitted: (text) {
                                      _challengeProvider.addtags(text,_challengeProvider.ProviderTags);
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      suffixIcon: IconButton(
                                        ...
                                        onPressed: () {
                                          _challengeProvider.addtags(tagscontroller.text.toString(),_challengeProvider.ProviderTags);
                                        },
                                      ),
                                      errorStyle: GoogleFonts.montserrat(
                                          textStyle: Theme
  ...
  Future<void> getChallengeCleanResponse(defaulttext) async {
    setState(() {
  ...
  Future<void> getChallengeExpandResponse( defaulttext,q3text,q4text,q5text,) async {
    setState(() {
      _messages.insert(0, defaulttext);
      // _typingUsers.add(_gptChatUser);
    });
    ...
    for (var element in response4!.choices) {
      if (element.message != null) {
        setState(() {
          ...
          _challengeProvider.keywordsssss = responseContent.split(',');

          // _addKeywordProvider.keywordsssss = [gptResponse];


        });
        print("_challengeProvider.keywordsssss: ${_challengeProvider.keywordsssss}");
    ...
    for (var element in response5!.choices) {
      if (element.message != null) {
        setState(() {
          ...
          _challengeProvider.ProviderTags = responseContent.split(',');
        });
        print("_addKeywordProvider.ProviderTags: ${_challengeProvider.ProviderTags}");
        print("response: ${element.message!.content}");
      }
    }
    ...
    for (var element in response4!.choices) {
      if (element.message != null) {
        setState(() {
          ...
          _challengeProvider.newaddkeywordsList(editKeywordssss);


          // _addKeywordProvider.keywords.replaceRange(0, _addKeywordProvider.keywords.length, element.message!.content.split(','));

        });
        print("_addKeywordProvider.keywords: ${_challengeProvider.keywords}");
        print("responsesssss: ${element.message!.content}");
      }
    }
    ...
    for (var element in response5!.choices) {
      if (element.message != null) {
        setState(() {
          ...
          _challengeProvider.newaddProviderEditTagsList(edittags);
        ...
        print("_addKeywordProvider.ProviderEditTags: ${_challengeProvider.ProviderEditTags}");
        print("response: ${element.message!.content}");
      }
    }
            ...
            child: AlertDialog(
                      ...
                      InkWell(
                        onTap: () async {
                          ...
                          _editcontroller.document.isEmpty() ||
                            ...
                            await ApiRepository().updateChallenges({
                              "Challenge Status": editstatusvalue,
                ...
                title: Column(
                  ...
                  children: [
                    ...
                    (createdat.toString().isNotEmpty) ? Padding(
                      padding: const EdgeInsets.only(left: 20.0),
                      child: Text("Entered Date: $createdat",
                          overflow: TextOverflow.ellipsis,
                          style: GoogleFonts.montserrat(textStyle:
                          Theme.of(context).textTheme.titleSmall,)
                      ),
                              ...
                              builder: (ctx, AsyncSnapshot<DocumentSnapshot> snapshot) {
                                if (snapshot.connectionState == ConnectionState.done) {
                                  ...
                                  if (snapshot.hasError) {
                                    ...
                                    editstatusvalue = doc?.get("Challenge Status");
                                    // editstatusvalue = 'New';//doc?.get("Thirver Status");
                                    // editstatusvalue = (doc?.get("Challenge Status") == "" ||doc?.get("Challenge Status") == null ) ? 'New' : doc?.get("Challenge Status");
                                                ...
                                                Flexible(
                                                  child: Padding(
                                                    ...
                                                    child: DropdownButtonFormField<String>(
                                                      ...
                                                      // onChanged: null,
                                                      items: _challengeProvider.ChallengesSourceItems.map((item) {
                                                        return DropdownMenuItem<String>(
                                                          value: item,
                                                          child: Text(item),
                                                        );
                                                ...
                                                Flexible(
                                                  child: Padding(
                                                    ...
                                                    child: DropdownButtonFormField<String>(
                                                      ...
                                                      // onChanged: null,
                                                      items: _challengeProvider.ChallengesStatusItems.map((item) {
                                                        return DropdownMenuItem<String>(
                                                          value: item,
                                                          child: Text(item),
                                                        );
                                                  ...
                                                  return Padding(
                                                    ...
                                                    child: TypeAheadField(
                                                      ...
                                                      onSuggestionSelected: (String suggestion) {
                                                        ...
                                                        challengesProvider.addkeywordschip(suggestion,editKeywordssss);
                                                  ...
                                                  return Padding(
                                                    ...
                                                    child: Align(
                                                      ...
                                                      child: Wrap(
                                                        ...
                                                        alignment: WrapAlignment.start,
                                                        runAlignment: WrapAlignment.start,
                                                        children: challengeProvider.keywords.map((item){
                                                          print("item: $item");
                                                          print("addKeywordProvider.keywords: ${challengeProvider.keywords}");
                                                          return Container(
                                                            height: 50,
                                                            // width: 200,
                                                            margin: EdgeInsets.only(bottom: 10),
                                                            ...
                                                            child: Row(
                                                              ...
                                                              children: [
                                                                ...
                                                                IconButton(
                                                                    onPressed: ()async{
                                                                      // addKeywordProvider.newKeywordsList.remove(item);
                                                                      _challengeProvider.removekeywords(item);
                                            ...
                                            Padding(
                                              ...
                                              child: TypeAheadField(
                                                ...
                                                onSuggestionSelected: (String suggestion) {
                                                  ...
                                                  _challengeProvider.addtags(edittagscontroller.text.toString(),edittags);
                                                  edittagscontroller.clear();
                                                ...
                                                textFieldConfiguration: TextFieldConfiguration(
                                                  controller: edittagscontroller,
                                                  onSubmitted: (text) {
                                                    _challengeProvider.addtags(text,edittags);
                                                    edittagscontroller.clear();
                                                    // print("tags: $tags");
                                                  },
                                                  style: GoogleFonts.poppins(
                                                  ...
                                                  return Padding(
                                                    ...
                                                    child: Align(
                                                      ...
                                                      child: Wrap(
                                                        ...
                                                        alignment: WrapAlignment.start,
                                                        runAlignment: WrapAlignment.start,
                                                        children: challengesProvider.ProviderEditTags.map((item){
                                                          return Container(
                                                            height: 50,
                                                            // width: 200,
                                                            padding: EdgeInsets.all(8),
                                              ...
                                              child: SingleChildScrollView(
                                                child: Column(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      (_challengeProvider.keywords==""|| _challengeProvider.keywords==null||_challengeProvider.keywords.isEmpty) ? Container() :     Row(
                                                        mainAxisAlignment: MainAxisAlignment.start,
                                                        crossAxisAlignment: CrossAxisAlignment.start,
                                                        children: [
                                                      ...
                                                      (_challengeProvider.ProviderEditTags==""|| _challengeProvider.ProviderEditTags==null||_challengeProvider.ProviderEditTags.isEmpty) ? Container() :  Row(
                                                        mainAxisAlignment: MainAxisAlignment.start,
                                                        crossAxisAlignment: CrossAxisAlignment.start,
                                                        children: [
...
class ChallengeCategoryServices {
  static Future<List<String>> getSuggestions(String query) async {
    List<String> matches = [];
    // print("Getting Suggestion For " + query);

    try {
      DocumentSnapshot snapshot = await FirebaseFirestore.instance.collection('Keywords').doc("CUTs7fvcYX2dN9TnDj4c").get();
